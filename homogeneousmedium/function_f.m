...
% temporal_temp_rk2
temporal_temp_rk2 = (1 - 2 * (pi * f_0 * (t - 0.1))^2) * exp(-(pi * f_0 * (t - 0.1))^2);

% temporal_temo_rk1d1t
temporal_temo_rk1d1t = (-4 * pi^2 * f_0^2 * t) * exp(-pi^2 * f_0^2 * t^2) + ...
...
r=temporal_temp_rk1d1t * space_temp_exp; 
