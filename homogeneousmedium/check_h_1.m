...
%[L2_error_6,H1_error_6,DG_broken_error_6,data_6,CPU_time_6]=DG_wave_triangulation(Iter_refinement,basis_type,eipsilon,sigma,beta,theta,N_T,T);
...
CPU_time=[CPU_time_1;CPU_time_2;CPU_time_3;CPU_time_4;CPU_time_5];%CPU_time_6];
...
disp(T2);
disp('p=1,N_T=2^(Iter_refinement*2),at T=0.01,sigma=1000');
...
% ,N,N.^(-5/2),'k--');
h2=legend('$||u-u_h||_0$','$||u-u_h||_{\star}$','$ch^2$','$ch$','Location','southwest'); %在图形的左下角创建图例 h2，用来标识图中的曲线
