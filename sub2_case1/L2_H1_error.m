function temp=L2_H1_error(DGM,DGT,X,func_name,t,basis_type,der_order_x,der_order_y,Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle)
...
for n=1:size(DGT,2)
    ...
    for k=1:length(Gauss_coefficient_local_triangle)
        temp=temp+Gauss_coefficient_local_triangle(k)*(feval(func_name,Gauss_point_local_triangle(k,1),Gauss_point_local_triangle(k,2),t)...
