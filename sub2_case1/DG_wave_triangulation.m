function [L2_error,H1_error, DG_broken_error,r_2,CPU_time]=DG_wave_triangulation(Iter_refinement,basis_type,eipsilon,sigma,beta,theta,T,constant,coefficient)
% 04/26/2016
