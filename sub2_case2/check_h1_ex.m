...
semilogy(X,eL2,'b-s',X,eH1,'c-x',X,eDGbroken,'g-O',X,slopeL2,'k--',X,slopeH1,'y--',X,slopeDGbroken,'r--','LineWidth',1.5); %在图形窗口中绘制四条曲线，字符串参数分别指定数据样式和颜色（蓝色实线代表 eL2，绿色圆圈代表 eDGbroken，黑色虚线代表 slopeL2，红色虚线代表 slopeDGbroken)
% ,N,N.^(-5/2),'k--');
h2=legend('$||u-u_h||_0$','$||u-u_h||_1$','$||u-u_h||_{\star}$','$ch^2$','$ch$','$ch$','Location','northeast'); %在图形的左下角创建图例 h2，用来标识图中的曲线
