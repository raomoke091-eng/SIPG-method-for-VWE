...
disp(T2);
disp('p=3,N_T=2^(Iter_refinement*2)');
...
semilogy(X,eL2,'b-s',X,eDGbroken,'g-O',X,slopeL2,'k--',X,slopeDGbroken,'r--','LineWidth',1); %在图形窗口中绘制四条曲线，字符串参数分别指定数据样式和颜色（蓝色实线代表 eL2，绿色圆圈代表 eDGbroken，黑色虚线代表 slopeL2，红色虚线代表 slopeDGbroken)
% ,N,N.^(-5/2),'k--');
