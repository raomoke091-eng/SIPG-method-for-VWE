...
[L2_error_1,H1_error_1]=DG_wave_triangulation(Iter_refinement,basis_type,eipsilon,sigma,beta,theta,N_T,T);

Iter_refinement=6;N_T=4;
[L2_error_2,H1_error_2]=DG_wave_triangulation(Iter_refinement,basis_type,eipsilon,sigma,beta,theta,N_T,T);

Iter_refinement=6;N_T=8;
[L2_error_3,H1_error_3]=DG_wave_triangulation(Iter_refinement,basis_type,eipsilon,sigma,beta,theta,N_T,T);
...
format short;
T2=table(delta_t,eL2Order,eH1Order);
disp(T2);
