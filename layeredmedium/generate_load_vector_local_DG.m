...
for n=1:size(DGT,2)
    ...
    for k=1:length(Gauss_coefficient_local_triangle)  
        a=feval(func_right_term,Gauss_point_local_triangle(k,1),Gauss_point_local_triangle(k,2),t)...
            *triangular_local_basis(Gauss_point_local_triangle(k,1),Gauss_point_local_triangle(k,2),basis_type...
                                ,0,0);
