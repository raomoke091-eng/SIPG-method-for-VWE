...
for n=1:size(DGT,2) %遍历每个三角单元
    ...
    for k=1:length(Gauss_coefficient_local_triangle)
        temp1=temp1+h_n^2*Gauss_coefficient_local_triangle(k)*(feval(func_name_1,Gauss_point_local_triangle(k,1),Gauss_point_local_triangle(k,2),t)...
        ...
        temp2=temp2+h_n^2*Gauss_coefficient_local_triangle(k)*(feval(func_name_2,Gauss_point_local_triangle(k,1),Gauss_point_local_triangle(k,2),t)...
        ...
        temp3=temp3+h_n^2*Gauss_coefficient_local_triangle(k)*(feval(func_name_3,Gauss_point_local_triangle(k,1),Gauss_point_local_triangle(k,2),t)...
        ...
        temp4=temp4+h_n^2*Gauss_coefficient_local_triangle(k)*(feval(func_name_4,Gauss_point_local_triangle(k,1),Gauss_point_local_triangle(k,2),t)...
